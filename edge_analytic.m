...
for ji=1:1:Nline % integration sampling points
    ...
    elseif edge_type(ed1in)==2 % if edge is on input port, contribution from K and b
        count=count+1;
        ysr=(l_nd1y+l_nd2y)/2;
        K_el(1,1)=K_el(1,1)+wwLine*imj*kx*(1/(4*areatr*areatr))*(a1+b1*xLine+c1*yLine)^2;
        K_el(2,2)=K_el(2,2)+wwLine*imj*kx*(1/(4*areatr*areatr))*(a2+b2*xLine+c2*yLine)^2;
        K_el(3,3)=K_el(3,3)+wwLine*imj*kx*(1/(4*areatr*areatr))*(a3+b3*xLine+c3*yLine)^2;
        K_el(1,2)=K_el(1,2)+wwLine*imj*kx*(1/(4*areatr*areatr))*(a1+b1*xLine+c1*yLine)*(a2+b2*xLine+c2*yLine);
        K_el(1,3)=K_el(1,3)+wwLine*imj*kx*(1/(4*areatr*areatr))*(a1+b1*xLine+c1*yLine)*(a3+b3*xLine+c3*yLine);
        K_el(2,3)=K_el(2,3)+wwLine*imj*kx*(1/(4*areatr*areatr))*(a2+b2*xLine+c2*yLine)*(a3+b3*xLine+c3*yLine);
        K_el(2,1)=K_el(1,2);
        K_el(3,1)=K_el(1,3);
        K_el(3,2)=K_el(2,3);
        
        b_el(1,1)=b_el(1,1)+wwLine*2*c0*c0*imj*kx*te_even_mode(ysr,E0,Order,d)*(a1+b1*xLine+c1*yLine);
        b_el(2,1)=b_el(2,1)+wwLine*2*c0*c0*imj*kx*te_even_mode(ysr,E0,Order,d)*(a2+b2*xLine+c2*yLine);
        b_el(3,1)=b_el(3,1)+wwLine*2*c0*c0*imj*kx*te_even_mode(ysr,E0,Order,d)*(a3+b3*xLine+c3*yLine);
